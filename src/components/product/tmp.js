...
function Products(props) {
    ...
    const setDisable1 = (product, event) => {
        // event.preventDefault()
        if (flagSubmit) {
            setFlagSubmit(false)
        }
    ...
    const setDisable = (product, event) => {
        debugger
        // event.preventDefault()
        if (flagSubmit) {
            setFlagSubmit(false)
            ...
            <div>
                {
                    ...
                    //                                                                             ></MdEdit>
                    //                                                                             {/* : */}
                    //                                                                             {/* <AiTwotoneSave type="submit" id="icon"
                    //                                                                             onClick={(e) => setDisable(product, e)}
                    //                                                                         /> */}
                    //                                                                             {/* } */}
                    //                                                                         </button>
                    //                                                                     </Tooltip>
