      ...
      <div className="wrap_invoice" style={{ height: window.location.href.indexOf("view") != -1 ? '100vh' : '80vh' }}>
        <div className={flagLoud ? 'flagLoudOp' : ''}>
          ...
          <div id="bgImg" className={isMouseTooltipVisible ? "frameInvoice" : ""} style={{ border: 8 + 'px solid red' }}
            ...
            onMouseOver={() => {
              if (displayInvoice === "false")
                console.log("gfhftftgfhgcfgcg")
            }}
            style={{
                  ...
                  <Row onClick={() => focus_steps('Production', 1)}>
                    <Col md={4} className='m-auto'>
                      <input disabled={displayInvoice === "true" ? "disable" : ""} readOnly
                        ...
                        type="text"
                        // type="button" 
                        // onClick={detailsBusiness && detailsBusiness.socialmedias ? detailsBusiness.socialmedias.website ?
                        //   window.location.href =`https://${detailsBusiness.socialmedias.website}` :"":""}
...
// $('.left_nav').addClass('border_configurator') 
                ...
                <Col md={{ span: 4, offset: 9 }} className="total-temp1 text-right">
                  ...
                  <Row className=' font-weight-bold'>
                    ...
                    <Col md={4} className='totalSum-temp1 text-right pt-4 p-0'>{saveSum ? saveSum :
                      ''
                    }</Col>
...
export const Item = (props) => {
  ...
  useEffect(() => {
    ...
    // }
  }, [dtp, amount2, new_product[props.index], amountProductInvoice, discountp])
      ...
      <Row className='d-flex align-items-center row5 mr-0' style={flagBorderProduct[props.index] ? { border: '1px solid red' } : { border: 'none' }}>
        ...
        {props.pro.id == "null" || props.pro.id === undefined ?
          ...
          <Cell
            ...
            value={dtp.name ? dtp.name : new_product[props.index] ? new_product[props.index].name ? new_product[props.index].name : '' : ''}
            disabled={displayInvoice === "true" ? "" : "disable"}
        ...
        <Cell
          ...
          value={dtp.description ? dtp.description : new_product[props.index] ? new_product[props.index].description ? new_product[props.index].description : '' : ''}
        ...
        <Cell
          ...
          value={dtp.price ? dtp.price : new_product[props.index] ? new_product[props.index].price ? new_product[props.index].price : '' : ''}
          disabled={displayInvoice === "true" ? "" : "disable"}
        ...
        <Cell
          ...
          // value=""
          value={dtp.discont ? dtp.discount : new_product[props.index] ? new_product[props.index].discount ? new_product[props.index].discount : '' : ''}
